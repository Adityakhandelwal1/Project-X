...
@Component({
  selector: 'app-fivety-two-wk-high-component',
  templateUrl: './fivety-two-wk-high-component.component.html',
  styleUrls: ['./fivety-two-wk-high-component.component.scss']
})
export class FivetyTwoWkHighComponentComponent implements OnInit {
  ...
  public getAllStocks(){
    let url = "http://localhost:8080/getStocksHitting52High";
